<template>
    <div>
            ...
            <div class="addr-list-wrap">
              <div class="addr-list">
                <ul>
                  ...
                  <li class="addr-new" @click="addAddressModal">
      ...
      <modal :mdShow="addmdShow" @close="closeModal">
        <p slot="message"> 添加地址区域</p>
        <div slot="addAddress">
          <ul>
            <li class="regi_form_input">
              <span>姓名:</span>
              <input type="text" class="regi_login_input regi_login_input_left" v-model="userName">
            </li>
            <li class="regi_form_input">
              <span>地址:</span>
              <input type="text" class="regi_login_input regi_login_input_left" v-model="streetName">
            </li>
            <li class="regi_form_input">
              <span>邮编:</span>
              <input type="text" class="regi_login_input regi_login_input_left" v-model="postCode">
            </li>
            <li class="regi_form_input">
              <span>tel:</span>
              <input type="text" class="regi_login_input regi_login_input_left" v-model="tel">
            </li>
          </ul>
        </div>
        <div slot="btnGroup">
          <a href="javascript:;" class="btn btn--m" @click="addAddress">添加地址</a>
        </div>
      </modal>
      <modal :mdShow="ismdShow" @close="closeModal">
        <p slot="message">是否确认删除该地址</p>
        <div slot="btnGroup">
          <a href="javascript:;" class="btn btn--m" @click="delAddressTrue(delAddressId)">确认</a>
